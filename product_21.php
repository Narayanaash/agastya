        ...
        <div class="section-content">
          <div class="row">
            <div class="col-xs-12 col-sm-8 col-md-8 pull-left flip">
              <div class="row">
                <div class="col-md-12">
                 <img alt="" src="assets/product_details/cizawell.jpg" alt="" />
                </div>
              </div>
              <div class="row"><br><br>
                 <div class="col-md-12">
                    ...
                    <div class="tab-pane fade in active" id="tab1">
                      <h3>Product Description</h3>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>Calcium Carbonate IP</td>
                            <td>500 mg (eq to Elemental calcium 200 mg)</td>
                          </tr>
                          <tr>
                            <td>Zinc Sulphate Monohydrate  IP  eq to elemental Zinc</td>
                            <td>7.5 mg</td>
                          </tr>
                          <tr>
