        ...
        <div class="section-content">
          <div class="row">
            <div class="col-xs-12 col-sm-8 col-md-8 pull-left flip">
              <div class="row">
                <div class="col-md-12">
                  <img alt="" src="assets/product_details/16.jpg" alt="" />
                </div>
              </div>
              <div class="row"><br><br>
                <div class="col-md-12">
                    ...
                    <div class="tab-pane fade in active" id="tab1">
                      <h3>Product Description</h3>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>Arogya Vardhani</td>
                            <td>125 mg</td>
                          </tr>
                          <tr>
                            <td>Bgarangraj Ghanstave</td>
                            <td>50 mg</td>
                          </tr>
                          <tr>
                            <td>Sounth (Zingiber Offcinale Rosc.)</td>
                            <td>50 mg</td>
                          </tr>
                          <tr>
                            <td>Makol (Solanum Nigrum Linn.)</td>
                            <td>50 mg</td>
                          </tr>
                          <tr>
                            <td>Kasni (Kasni)</td>
                          ...
                          <tr>
                            <td>Arjun Chall Ghanstave</td>
                            <td>50 mg</td>
                          </tr>
                          <tr>
                            <td>Bhui Amala Ext.</td>
                            <td>125 mg</td>
                          </tr>
                          <tr>
