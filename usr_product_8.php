        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12 text-center">
              <h2 class="title">Usr Product Details</h2>
              <ol class="breadcrumb text-center text-black mt-10">
                <li><a href="./">Home</a></li>
                <li class="active text-theme-colored">Usr Product Details</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-xs-12 col-sm-8 col-md-8 pull-left flip">
              <div class="row">
                <div class="col-md-12">
                  <img alt="" src="images/products/usr/9.jpg" alt="" />
                </div>
              </div>
              <div class="row"><br><br>
                 <div class="col-md-12">
