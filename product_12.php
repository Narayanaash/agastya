        ...
        <div class="section-content">
          <div class="row">
            <div class="col-xs-12 col-sm-8 col-md-8 pull-left flip">
              <div class="row">
                <div class="col-md-12">
                  <img alt="" src="assets/product_details/12.jpg" alt="" />
                </div>
              </div>
              <div class="row"><br><br>
                <div class="col-md-12">
                    ...
                    <div class="tab-pane fade in active" id="tab1">
                      <h3>Product Description</h3>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>Sodium (Sterile) IP eq to Anhydrous Ceftriaxone</td>
                            <td>1000 mg</td>
                          </tr>
                          <tr>
                            <td>Sulbactam Sodium  (Sterile) USP eq to Sulbactam</td>
                            <td>500 mg</td>
                          </tr>
                        </tbody>
                      </table>
